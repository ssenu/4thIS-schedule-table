...
이름 목록과 표를 가르는 선에 붙은 손잡이를 누르면 **목록을 접어** 표를 넓게 볼
수 있습니다. 접어 둔 상태는 그 브라우저에 기억됩니다.

비밀번호는 본인 일정을 지키기 위한 것입니다. 관리자 비밀번호로는 모든 일정을
고칠 수 있고, **카테고리(학년) 자체를 만들고 지우는 것은 관리자만** 할 수 있습니다.
...
이름을 끌어 순서와 소속을 바꾸는 것은 **누구나** 할 수 있습니다. 목록을 보기 좋게
놓는 일이고 되돌리기도 끌어다 놓으면 그만이라, 매번 관리자를 찾을 이유가 없습니다.
이름 자체를 고치거나 지우는 것은 여전히 본인과 관리자만 할 수 있습니다.
